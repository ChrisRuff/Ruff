...
struct CameraBufT : public flatbuffers::NativeTable {
  ...
  std::unique_ptr<Intrinsics> intrinsics{};
  std::unique_ptr<Extrinsics> extrinsics{};
  std::unique_ptr<DistortionCoeffs> dist_coeffs{};
  CameraBufT() = default;
...
inline CameraBufT::CameraBufT(const CameraBufT &o)
      : intrinsics((o.intrinsics) ? new Intrinsics(*o.intrinsics) : nullptr),
        extrinsics((o.extrinsics) ? new Extrinsics(*o.extrinsics) : nullptr),
        dist_coeffs((o.dist_coeffs) ? new DistortionCoeffs(*o.dist_coeffs) : nullptr) {
}
...
inline void CameraBuf::UnPackTo(CameraBufT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = intrinsics(); if (_e) _o->intrinsics = flatbuffers::UnPack(*_e); }
  { auto _e = extrinsics(); if (_e) _o->extrinsics = flatbuffers::UnPack(*_e); }
  { auto _e = dist_coeffs(); if (_e) _o->dist_coeffs = flatbuffers::UnPack(*_e); }
}
...
inline flatbuffers::Offset<CameraBuf> CreateCameraBuf(flatbuffers::FlatBufferBuilder &_fbb, const CameraBufT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _intrinsics = flatbuffers::Pack(_o->intrinsics);
  auto _extrinsics = flatbuffers::Pack(_o->extrinsics);
  auto _dist_coeffs = flatbuffers::Pack(_o->dist_coeffs);
