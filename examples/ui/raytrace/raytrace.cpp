...
class Ray
  : public ruff::ui::
      RayEngine<map_width, map_height, num_cells_x, num_cells_y>
{
public:
	...
	void onCreate() override
	{
		for(size_t i = 0; i < num_cells_x; ++i)
		{
			ruff::ui::RayEngine<map_width,
			                    map_height,
			                    num_cells_x,
			                    num_cells_y>::tile_map.at(i, 0)
			  .wall = true;

			ruff::ui::RayEngine<map_width,
			                    map_height,
			                    num_cells_x,
			                    num_cells_y>::tile_map
			  .at(i, num_cells_x - 1)
			  .wall = true;
		}
		...
		ruff::ui::RayEngine<map_width,
		                    ...
		                    num_cells_x,
		                    num_cells_y>::tile_map
		  .at(num_cells_x / 2, num_cells_y / 2)
		  .wall = true;
	}
